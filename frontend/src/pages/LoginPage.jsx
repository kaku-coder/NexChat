...
import { loginContent, brandContent } from "../content/authContent";
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 md:p-6 font-sans antialiased selection:bg-rose-500 selection:text-white overflow-y-auto">
      ...
      >
        ...
        <div className="lg:col-span-5 relative min-h-[350px] lg:min-h-[500px] bg-zinc-900 overflow-hidden m-2.5 rounded-2xl group">
          ...
          <img 
            src="/src/assets/Programmer_using_laptop_chatting…_202607050950.jpeg" 
        ...
        <div className="lg:col-span-7 flex flex-col justify-center p-6 md:p-8 lg:p-10">
          <div className="w-full max-w-md mx-auto">
            {/* Heading */}
            <div className="mb-5">
              <h2 className="text-2xl font-bold tracking-tight text-white mb-1">{loginContent.title}</h2>
              <p className="text-zinc-500 text-xs">{loginContent.subtitle}</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase">{loginContent.emailLabel}</label>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <label className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase">{loginContent.passwordLabel}</label>
                  <Link
                    to="/forgot-password"
              ...
              >
                {loading ? "Signing in..." : loginContent.submitButtonText}
              </button>
            </form>
